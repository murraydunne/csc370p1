...
public class AirlineFlights extends HttpServlet{
	...
	throws IOException {
		...
		try {
			...
			out.println(
						"<form method=\"GET\" action=\"/csc370p1/airlineflights\" >" +
						"Select an Airline: <select name=\"acode\">");
						//airline code 
			...
			if (acode != null) {
				int acodeval = Integer.parseInt(acode);
